...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/proud-limit-6187)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/proud-limit-6187
```

A live public deployment of this template is available at [https://proud-limit-6187.templates.workers.dev](https://proud-limit-6187.templates.workers.dev)
